...
public record TransactionRefundSubmitted : IIntegrationEvent, ISpecificRecord
{
    ...
    public List<CheckoutDto> TransactionItems { get; set; } = [];
    ...
    public void Put(int fieldPos, object fieldValue)
    {
        switch (fieldPos)
        {
            ...
            case 4: TransactionItems = (List<CheckoutDto>)fieldValue; break;
            case 5: Address = Address.Create((string)fieldValue); break;
            case 6: Version = (int)fieldValue; break;
            case 7: CreatedAt = DateTime.FromBinary((long)fieldValue); break;
