...
public record TransactionSubmitted : IIntegrationEvent, ISpecificRecord
{
    ...
    public void Put(int fieldPos, object fieldValue)
    {
        switch (fieldPos)
        {
            ...
            case 3: TransactionItems = (List<CheckoutDto>)fieldValue; break;
            case 4: Address = Address.Create((string)fieldValue); break;
