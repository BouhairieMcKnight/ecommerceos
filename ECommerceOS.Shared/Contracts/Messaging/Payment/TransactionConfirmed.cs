...
public record TransactionConfirmed : ISpecificRecord, IIntegrationEvent
{
    public static readonly Schema _SCHEMA = Avro.Schema.Parse(
        """
        {
          ...
          "displayName": "Transaction Confirmed",
          "namespace": "ECommerceOS.Shared.Contracts.Messaging.Payment",
          "fields": [
    ...
    public void Put(int fieldPos, object fieldValue)
    {
        switch (fieldPos)
        {
            ...
            case 3: Total = Money.Create((string)fieldValue); break;
