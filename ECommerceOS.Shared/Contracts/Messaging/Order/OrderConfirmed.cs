...
public record OrderConfirmed : ISpecificRecord, IIntegrationEvent
{
    ...
    public required DateTimeOffset ExpectedDeliveryDate { get; set; }
    ...
    public object? Get(int fieldPos)
    {
        return fieldPos switch
        {
            ...
            3 => OrderItems,
            4 => ExpectedDeliveryDate.ToUnixTimeMilliseconds(),
            5 => Version,
    ...
    public void Put(int fieldPos, object fieldValue)
    {
        switch (fieldPos)
        {
            ...
            case 4: ExpectedDeliveryDate = DateTimeOffset.FromUnixTimeMilliseconds((long)fieldValue); break;
