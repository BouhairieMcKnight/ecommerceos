...
/// <summary>
/// Implements the IHealthCheck and IDisposable interfaces for providing health checks on schema registry containers
/// </summary>
/// <param name="options"></param>
public class SchemaRegistryHealthCheck(SchemaRegistryHealthCheckOptions options) : IHealthCheck, IDisposable
{
